...
public partial class TranslationService : ITranslationService
{
    ...
    private static string TranslateWithTemplates(string text, IReadOnlyDictionary<string, string> staticTranslations, string language)
    {
        ...
        if (welcomeMatch.Success)
        {
            ...
            return language switch
            {
                "pidgin" => $"Welcome to the banking service. Your number na {phone}. Press 1 for English. Press 2 for Pidgin. Press 3 for Yoruba. Press 4 for Igbo. Press 5 for Hausa.",
                "yo" => $"E kaabo si ise ifowopamo wa. Nọmba rẹ ni {phone}. Tẹ 1 fun Gẹẹsi. Tẹ 2 fun Pidgin. Tẹ 3 fun Yoruba. Tẹ 4 fun Igbo. Tẹ 5 fun Hausa.",
                "ig" => $"Nnoo na ọrụ banki anyi. Nọmba gị bụ {phone}. Pịa 1 maka Bekee. Pịa 2 maka Pidgin. Pịa 3 maka Yoruba. Pịa 4 maka Igbo. Pịa 5 maka Hausa.",
                "ha" => $"Barka da zuwa sabis din bankinmu. Lambar ka ita ce {phone}. Danna 1 don Turanci. Danna 2 don Pidgin. Danna 3 don Yoruba. Danna 4 don Igbo. Danna 5 don Hausa.",
                _ => text
            };
        }
    ...
    [GeneratedRegex(@"^Welcome to the banking service\. Your number is (?<phone>.+)\. Press 1 for English\. Press 2 for Pidgin\. Press 3 for Yoruba\. Press 4 for Igbo\. Press 5 for Hausa\.$")]
